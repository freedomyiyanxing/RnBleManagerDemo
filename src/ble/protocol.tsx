...
export default class BleProtocol {
  public trailStatus: boolean;
  public receiveData: Array<any>;
  public packetLen: number | undefined;
  public receivedDelayTimer: NodeJS.Timeout | null;
  constructor() {
    this.trailStatus = true; //接收到包头后，接收包尾的状态，一个完整数据包的接收状态
    this.receiveData = []; //接收蓝牙数据缓存
    this.receivedDelayTimer = null;
  }
